...
const styles = StyleSheet.create({
  ...
  categoryRow: { gap: spacing.xs, paddingBottom: spacing.sm },
  categoryChip: { paddingHorizontal: spacing.sm, paddingVertical: spacing.xs, borderRadius: radius.sm, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
